...
Quick reference table of all available skills:

| Skill Name | Category | Entrypoint | Status |
|------------|----------|------------|--------|
| [Brand Guidelines](./brand-guidelines/) | Business & Marketing | `brand-guidelines/SKILL.md` | ✓ Active |
| [Competitive Ads Extractor](./competitive-ads-extractor/) | Business & Marketing | `competitive-ads-extractor/SKILL.md` | ✓ Active |
| [Domain Name Brainstormer](./domain-name-brainstormer/) | Business & Marketing | `domain-name-brainstormer/SKILL.md` | ✓ Active |
| [Internal Comms](./internal-comms/) | Business & Marketing | `internal-comms/SKILL.md` | ✓ Active |
| [Lead Research Assistant](./lead-research-assistant/) | Business & Marketing | `lead-research-assistant/SKILL.md` | ✓ Active |
...
| [Document Skills Xlsx](./document-skills/xlsx/) | Productivity & Organization | `document-skills/xlsx/SKILL.md` | ✓ Active |
| [File Organizer](./file-organizer/) | Productivity & Organization | `file-organizer/SKILL.md` | ✓ Active |
| [Invoice Organizer](./invoice-organizer/) | Productivity & Organization | `invoice-organizer/SKILL.md` | ✓ Active |
| [Raffle Winner Picker](./raffle-winner-picker/) | Productivity & Organization | `raffle-winner-picker/SKILL.md` | ✓ Active |
